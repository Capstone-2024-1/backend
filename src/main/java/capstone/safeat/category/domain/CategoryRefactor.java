...
public enum CategoryRefactor {
  ...
  public Optional<CategoryRefactor> getParent() {
    return Optional.ofNullable(parent);
  }

  public List<CategoryRefactor> getChildren() {
    final List<CategoryRefactor> children = new ArrayList<>();
    for (final CategoryRefactor category : CategoryRefactor.values()) {
